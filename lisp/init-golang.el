...
;; add by guoby at 2018 read go web program
...
;; speedbar
;;(speedbar 1)
;; (speedbar-add-supported-extension ".go") //not find speedbar-add-supported
...
;;最近使用go的模式会一会出现代码提示，一下有不会，刚刚使用了两个命令就可以了，不知道为什么？
